...
from PyQt5.QtWidgets import (
    ...
    QListView, QStatusBar, QProgressBar, QWidget, QAbstractItemView,
...
def has_aspect_ratio(width, height, ratio):
    ...
    return (1 - TOLERANCE) * expected_ratio <= calculated_ratio <= (1 + TOLERANCE) * expected_ratio
...
class Walmover(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Walmover 2")
